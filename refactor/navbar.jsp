        ...
        <div class="container"><a class="navbar-brand logo" href="#">ADMIN</a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item"><a class="nav-link active" href="stat">Statistique</a></li>
                    <li class="nav-item"><a class="nav-link active" href="categorie">Categories</a></li>
                    <li class="nav-item"><a class="nav-link active" href="demande">Demandes de recharge</a></li>
                </ul>
            </div>
        </div>
    </nav>